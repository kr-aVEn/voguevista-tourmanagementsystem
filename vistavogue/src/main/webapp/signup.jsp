<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="vistavogue.dao.LoginDAO" %>
    ...
    <main>
        <form id="login_form" class="form_class" action="" method="post">
            <div class="form_div">
                ...
                <label>Email:</label>
                <input class="field_class" name="email" type="email" placeholder="Enter email " autofocus>

                <label>Password:</label>
                <input id="pass" class="field_class" name="password" type="password" placeholder="Enter Password">
                <label>Place:</label>
                <input class="field_class" name="place" type="text" placeholder="Enter your location " autofocus>
